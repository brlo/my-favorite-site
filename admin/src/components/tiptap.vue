<template>
  <div v-if="editor" id='quotes-content'>
...
<script>
  import { Editor, EditorContent } from 'https://esm.sh/@tiptap/vue-3'
  ...
  const app = createApp({
    template: document.querySelector('#vue-editor'),
    ...
    mounted() {
      this.editor = new Editor({
        ...
        content: document.querySelector('#quotes-body-content').innerHTML,
      })
    },
