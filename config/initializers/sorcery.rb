...
Rails.application.config.sorcery.submodules = %w[
  user_activation reset_password remember_me brute_force_protection activity_logging
]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `60 * 60 * 24 * 7`
    #
    # user.remember_me_for = 60 * 60 * 24 * 90
    ...
    # Default: `nil`
    #
    # user.activation_token_expiration_period = 60 * 60 * 24 * 2
