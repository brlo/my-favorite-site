...
class PdfGenerator
  ...
  def self.path_to_page_pdf(page, is_rebuild: false)
    ...
    # КАРТИНКА
    #
    # Из-за добавления картинки, размер итогового файла увеличивается в 2 раза (на 1 МБ примерно)
    # if page.cover?
    #   html += "
    #     <div class='flex-wrap img-header-wrap'>
    #       <div class='blured'>
    #         <img src='#{ page.cover.large.url }' draggable='false'/>
    #       </div>
    #       <div class='content'>
    ...
    ::File.open("public/#{page_pdf_path}", 'wb') { |f| f.write(pdf) }
